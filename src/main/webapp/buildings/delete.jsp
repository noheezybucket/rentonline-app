...
<div>
    <form action="delete-process.building" method="post" class="space-y-5 mt-4">
        <input
                type="text"
                id="id"
                name="id"
        ...
        <div class="flex justify-center gap-10">
            <input type="submit" id="submit" name="submit" value="Supprimer l'immeuble" class="block bg-red-600 rounded-md px-5 py-2.5 font-medium text-white shadow w-full"/>
        </div>
    </form>
</div>
</body>
